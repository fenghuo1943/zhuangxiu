...
import { usePendingUploadsCleanup } from '../hooks/usePendingUploadsCleanup';
...
const DiaryPage: React.FC = () => {
  ...
  const {
    pendingUrlsRef: pendingDraftImageUrlsRef,
    trackUploadedUrls,
    removeTrackedUrl,
    clearTrackedUrls,
    cleanupPendingUploads,
  } = usePendingUploadsCleanup();
