  ...
  return (
    <AppShell currentPage="account">
      <div className="placeholder-page">
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          <Link to="/category-manage" style={{ display: 'flex', alignItems: 'center', gap: 12, padding: 20, textDecoration: 'none', color: 'inherit' }}>
            ...
            <div style={{ flex: 1 }}>
              <h3 style={{ margin: '0 0 2px', fontSize: 15 }}>📂 分类管理</h3>
              <p style={{ margin: 0, fontSize: 13, color: 'var(--color-text-muted)' }}>管理账单子分类和采购物品分类</p>
            </div>
