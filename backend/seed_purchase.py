...
- 8 stages (准备阶段 through 软装阶段)
- 29 subgroups
- 155 reference items

IDs use deterministic prefixes (stage_0..7, sub_0_0..7_1, item_0_0_0..7_1_X)
...
async def seed_purchase_references(db: AsyncSession) -> int:
    ...
    Uses deterministic IDs (stage_0..7, sub_0_0..7_1, item_0_0_0..7_1_X)
    so re-runs are safe.
    """
